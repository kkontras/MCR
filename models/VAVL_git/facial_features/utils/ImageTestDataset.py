...
from models.VAVL_git.facial_features.utils.FaceDetector import FAN
from models.VAVL_git.facial_features.utils.ImageDatasetHelpers import bbox2point
...
class TestData(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.scaling_factor != 1.0:
            image = rescale(image, (self.scaling_factor, self.scaling_factor, 1)) * 255.0
        ...
        if not isinstance(src_pts, list):
            ...
            return {
                "image": torch.tensor(dst_images).float(),
