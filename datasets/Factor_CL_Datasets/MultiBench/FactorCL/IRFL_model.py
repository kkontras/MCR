...
def mlp_head(dim_in, feat_dim):
    return nn.Sequential(nn.Linear(dim_in, dim_in), nn.ReLU(inplace=True), nn.Linear(dim_in, feat_dim))
...
class FactorCLSUP(nn.Module):
    def __init__(
        ...
        # critics
        self.infonce_x1x2 = InfoNCECritic(
            self.feat_dims[0],
            self.feat_dims[1],
        ...
        self.club_x1x2_cond = CLUBInfoNCECritic(
            self.feat_dims[0] + self.y_ohe_dim,
            self.feat_dims[1] + self.y_ohe_dim,
            self.critic_hidden_dim,
            self.critic_layers,
            activation,
            temperature=temperature,
        ...
        self.infonce_x1y = InfoNCECritic(
            self.feat_dims[0],
            1,
            self.critic_hidden_dim,
            self.critic_layers,
        ...
        self.infonce_x2y = InfoNCECritic(
            self.feat_dims[1],
            1,
            self.critic_hidden_dim,
            self.critic_layers,
        ...
        self.infonce_x1x2_cond = InfoNCECritic(
            self.feat_dims[0] + self.y_ohe_dim,
            self.feat_dims[1] + self.y_ohe_dim,
            self.critic_hidden_dim,
            self.critic_layers,
        ...
        self.club_x1x2 = CLUBInfoNCECritic(
            self.feat_dims[0],
            self.feat_dims[1],
            self.critic_hidden_dim,
            self.critic_layers,
        ...
        self.linears_list = [
            self.linears_infonce_x1x2,
            self.linears_club_x1x2_cond,
            self.linears_infonce_x1y,
            self.linears_infonce_x2y,
            self.linears_infonce_x1x2_cond,
            self.linears_club_x1x2,
        ]
        self.critics_list = [
            self.infonce_x1x2,
            self.club_x1x2_cond,
    ...
    def forward(self, x):
        ...
        uncond_losses = [
            self.infonce_x1x2(
                self.linears_infonce_x1x2[0](x1_embed),
        ...
        cond_losses = [
            self.infonce_x1x2_cond(
                torch.cat([self.linears_infonce_x1x2_cond[0](x1_embed), y_ohe], dim=1),
                torch.cat([self.linears_infonce_x1x2_cond[1](x2_embed), y_ohe], dim=1),
            ),
            self.club_x1x2_cond(
                torch.cat([self.linears_club_x1x2_cond[0](x1_embed), y_ohe], dim=1),
    ...
    def learning_loss(self, x):
        ...
        learning_losses = [
            ...
            self.club_x1x2_cond.learning_loss(
                torch.cat([self.linears_club_x1x2_cond[0](x1_embed), y_ohe], dim=1),
                torch.cat([self.linears_club_x1x2_cond[1](x2_embed), y_ohe], dim=1),
            ),
        ]
    ...
    def get_optims(self):
        ...
        CLUB_params = [self.club_x1x2_cond.parameters(), self.club_x1x2.parameters()]
    ...
    def forward(self, x1, x1_aug, x2, x2_aug, label):
        ...
        uncond_losses = [
            ...
            self.infonce_x1y(
                ...
                self.linears_infonce_x1y(x1_aug_embed),
            ),
            self.infonce_x2y(
                self.linears_infonce_x2y(x2_embed),
                self.linears_infonce_x2y(x2_aug_embed),
            ),
        ]
            ...
            self.infonce_x1x2_cond(
                torch.cat(
                    [
                        ...
                        self.linears_infonce_x1x2_cond[0](x1_aug_embed),
                    ],
                    dim=1,
                ),
                torch.cat(
                    [
                        ...
                        self.linears_infonce_x1x2_cond[1](x2_aug_embed),
                    ],
                    dim=1,
                ),
            ),
        ...
        learning_losses = [
            ...
            self.club_x1x2_cond.learning_loss(
                torch.cat(
                    [
                        self.linears_club_x1x2_cond[0](x1_embed),
                        self.linears_club_x1x2_cond[0](x1_aug_embed),
                    ],
                    dim=1,
                ),
                torch.cat(
                    [
                        self.linears_club_x1x2_cond[1](x2_embed),
                        self.linears_club_x1x2_cond[1](x2_aug_embed),
                    ],
                    dim=1,
                ),
            ),
...
def augment_image(image_batch):
    ...
    for img in image_batch:
        ...
        img_transform = transforms.Compose(
            [
                transforms.RandomResizedCrop(size=img.size, scale=(0.2, 1.0)),
