...
def train(
    ...
    temperature_decay=4.0,
    max_progression_levels=4,
    lr_surrogate=0.001,
...
class ModelSearcher:
    ...
    def search(
        ...
        """
        searchmethods = {
            "train_sampled_fun": avm.train_sampled_models,
        ...
        for si in range(self.search_iterations):
            ...
            for progression_index in range(self.max_prog):
                ...
                if si + progression_index == 0:
                    ...
                    all_accuracies = train_sampled_models(
                        all_configurations,
                        model_type,
                        dataloaders,
                        use_weightsharing,
                ...
                if si + progression_index == 0:
                    ...
                    sampled_k_confs = tools.sample_k_configurations(
                        all_configurations,
                        all_accuracies,
                        self.num_samples,
                        temperature,
                    ...
                    sampled_k_accs = train_sampled_models(
                        sampled_k_confs,
                        model_type,
                        dataloaders,
                        use_weightsharing,
