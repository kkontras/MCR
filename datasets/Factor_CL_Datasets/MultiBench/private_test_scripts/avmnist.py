...
class GP_LeNet(nn.Module):
    def __init__(self, args, in_channels):
        ...
        self.classifier = nn.Sequential(nn.Linear(int(4 * args.channels), args.num_outputs))
...
class GP_LeNet_Deeper(nn.Module):
    def __init__(self, args, in_channels):
        ...
        self.classifier = nn.Sequential(nn.Linear(int(16 * args.channels), args.num_outputs))
