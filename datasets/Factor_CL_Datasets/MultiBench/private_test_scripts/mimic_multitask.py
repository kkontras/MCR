...
from private_test_scripts.Simple_Late_Fusion_Multitask import test, train
...
traindata, validdata, testdata = get_dataloader(imputed_path="/home/yiwei/im.pk")

# build encoders, head and fusion layer
encoders = [
    MLP(5, 10, 10, dropout=False).to(torch.device("cuda:0" if torch.cuda.is_available() else "cpu")),
...
# train
train(encoders, fusion, head1, head2, traindata, validdata, 40, lr=0.01, save="best1.pt")
