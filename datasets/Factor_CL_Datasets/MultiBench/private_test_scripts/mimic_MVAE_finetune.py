...
from training_structures.MVAE_finetune import test_MVAE, train_MVAE
...
name = "b1"
traindata, validdata, testdata = get_dataloader(-1, imputed_path="datasets/mimic/im.pk", flatten_time_series=True)
classes = 6
n_latent = 200
series_dim = 12
timestep = 24
...
train_MVAE(
    ...
    35,
    5,
    savedirbackbone=name + "best1.pt",
    savedirhead=name + "back2.pt",
)
