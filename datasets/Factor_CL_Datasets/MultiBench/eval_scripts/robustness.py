                    ...
                    if t == task:
                        if (method == "EF" or method == "LF") and task in robustness[method + "-Transformer"]:
                            result[method] = helper(
                                (np.array(robustness[method][task]) + np.array(robustness[method + "-Transformer"][task])) / 2,
                                task,
                            )
                        else:
...
def single_plot(robustness_result, task, xlabel, ylabel, fig_name, method):
    ...
    axs.plot(
        np.arange(len(robustness_result)) / 10,
        robustness_result,
        label=method,
        linewidth=2.5,
    )
...
robustness["Best Unimodal"]["mimic mortality timeseries"] = [
    0.7679337829552422,
    0.7685469037400368,
    0.7664009809932557,
    0.76364193746168,
...
robustness["Best Unimodal"]["mimic 7 timeseries"] = [
    0.6799509503372164,
    0.6364193746167995,
    0.5836909871244635,
    0.5389331698344574,
...
robustness["Best Unimodal"]["mimic 1 timeseries"] = [
    0.9141630901287554,
    0.8966891477621092,
    0.8819742489270386,
    0.869098712446352,
...
robustness["Best Unimodal"]["finance F&B timeseries"] = [
    1.7468543529510498,
    1.7499454975128175,
    1.7556643962860108,
    1.835334587097168,
...
robustness["Best Unimodal"]["finance tech timeseries"] = [
    0.5087007701396942,
    0.5322327971458435,
    0.5292805194854736,
    0.5284122347831726,
...
robustness["Best Unimodal"]["finance health timeseries"] = [
    0.13544526994228362,
    0.13520690202713012,
    0.13254896998405458,
    0.13934721648693085,
...
robustness["Best Unimodal"]["enrico image"] = [
    0.476027397260274,
    0.4315068493150685,
    0.3664383561643836,
    0.3904109589041096,
...
robustness["Best Unimodal"]["enrico wireframe image"] = [
    0.4041095890410959,
    0.363013698630137,
    0.2808219178082192,
    0.2602739726027397,
...
robustness["Best Unimodal"]["imdb image micro"] = [
    0.38512736733829483,
    0.3530907850252784,
    0.3197661344726782,
    0.2827807770012917,
...
robustness["Best Unimodal"]["imdb image macro"] = [
    0.24226895575816887,
    0.20302311355322583,
    0.17458299723201112,
    0.14042485251724146,
    ...
    0.06856332971325599,
    0.06301048015726372,
    0.050413983851831226,
    0.03792263331281559,
    0.02630802107776935,
]
robustness["Best Unimodal"]["imdb text micro"] = [
    0.5653659841302863,
    0.5578369344634118,
    0.5504488330341114,
    0.5466415116940675,
...
robustness["Best Unimodal"]["imdb text macro"] = [
    0.45606721431009556,
    0.44743058548592096,
    0.438329928127804,
    0.42914264325501605,
...
robustness["Best Unimodal"]["robotics image"] = [
    0.00014103209832683206,
    0.00620879465714097,
    0.012023922987282276,
    0.016574595123529434,
    0.020169781520962715,
    0.022540835663676262,
    0.024388503283262253,
    0.02571929432451725,
    0.02669128030538559,
    0.027738867327570915,
]
robustness["Best Unimodal"]["robotics force"] = [
    0.00827085692435503,
    0.010384513065218925,
    0.010641143657267094,
    0.010816379450261593,
    0.010863110423088074,
    0.010730101726949215,
    0.010553873144090176,
    0.010225364938378334,
    0.009965472854673862,
    0.009790400974452496,
]
robustness["Best Unimodal"]["robotics proprio"] = [
    2.2045116566005163e-05,
    0.06653524935245514,
    0.1299981325864792,
    0.18672703206539154,
    0.2377871572971344,
...
robustness["Best Unimodal"]["gentle push image"] = [
    0.3402138374,
    8.570374729,
    9.515328663,
    9.994570034,
...
robustness["Best Unimodal"]["gentle push proprio"] = [
    3.882181227,
    10.11027428,
    11.5265418,
    12.31016493,
...
robustness["Best Unimodal"]["gentle push haptics"] = [
    4.258245598,
    5.56309104,
    5.6800898339999994,
    5.742590739,
...
robustness["Best Unimodal"]["gentle push controls"] = [
    3.801201145,
    8.296545031,
    8.199219515,
    8.063475853,
...
robustness["Best Unimodal"]["mosi text"] = [
    0.7421,
    0.7099,
    0.6237,
    0.5477,
...
robustness["Best Unimodal"]["mosi audio"] = [
    0.651,
    0.5965,
    0.5599,
    0.5488,
...
robustness["Best Unimodal"]["mosi image"] = [
    0.6733,
    0.6234,
    0.5919,
    0.5848,
...
robustness["Best Unimodal"]["mosei text"] = [
    0.7826,
    0.7121,
    0.6275,
    0.5434,
...
robustness["Best Unimodal"]["mosei audio"] = [
    0.659,
    0.5948,
    0.5613,
    0.5519,
...
robustness["Best Unimodal"]["mosei image"] = [
    0.6732,
    0.6349,
    0.5926,
    0.5713,
...
robustness["Best Unimodal"]["sarcasm text"] = [
    0.682,
    0.5926,
    0.5164,
    0.4393,
...
robustness["Best Unimodal"]["sarcasm audio"] = [
    0.6474,
    0.5968,
    0.5749,
    0.5436,
...
robustness["Best Unimodal"]["sarcasm image"] = [
    0.6612,
    0.6263,
    0.6041,
    0.5945,
...
robustness["Best Unimodal"]["humor text"] = [
    0.5742,
    0.5349,
    0.5078,
    0.4762,
...
robustness["Best Unimodal"]["humor audio"] = [
    0.5731,
    0.5657,
    0.5143,
    0.4678,
...
robustness["Best Unimodal"]["humor image"] = [
    0.5748,
    0.5375,
    0.5086,
    0.479,
...
robustness["LF"] = dict()
robustness["LF"]["mimic mortality timeseries"] = [
    0.7835683629675047,
    0.778969957081545,
    0.7676272225628449,
    0.765787860208461,
...
robustness["LF"]["mimic 7 timeseries"] = [
    0.6888412017167382,
    0.6615573267933783,
    0.6164929491109749,
    0.5524218270999387,
...
robustness["LF"]["mimic 1 timeseries"] = [
    0.9175352544451257,
    0.9022072348252606,
    0.8825873697118333,
    0.8666462293071735,
...
robustness["LF"]["finance F&B timeseries"] = [
    2.147226333618164,
    2.1456197261810304,
    2.1531070709228515,
    2.1734951019287108,
...
robustness["LF"]["finance tech timeseries"] = [
    0.5715468645095825,
    0.572181236743927,
    0.5732102513313293,
    0.5746765255928039,
...
robustness["LF"]["finance health timeseries"] = [
    0.13669011294841765,
    0.1372331202030182,
    0.13825314939022065,
    0.13884556889533997,
...
robustness["LF"]["enrico wireframe image"] = [
    0.5034246575342466,
    0.4965753424657534,
    0.4623287671232877,
    0.476027397260274,
...
robustness["LF"]["imdb image micro"] = [
    0.5972920696324951,
    0.5763660703419738,
    0.5561813313636783,
    0.5328480776409108,
...
robustness["LF"]["imdb image macro"] = [
    0.4966323045046603,
    0.47167172713170813,
    0.44649891922678564,
    0.4130371301721295,
...
robustness["LF"]["mosei multimodal"] = [
    0.7902,
    0.7055,
    0.6191,
    0.5443,
...
robustness["LF"]["sarcasm multimodal"] = [
    0.6616,
    0.5971,
    0.5564,
    0.5297,
...
robustness["LF"]["humor multimodal"] = [
    0.6194,
    0.5041,
    0.4772,
    0.4873,
...
robustness["LF"]["robotics proprio"] = [
    2.2035e-05,
    0.0586,
    0.1074,
    0.1544,
...
robustness["LF"]["gentle push image"] = [
    0.30024437449999997,
    6.489797876,
    7.298926889,
    7.837444693999999,
...
robustness["LF"]["gentle push proprio"] = [
    0.30024437449999997,
    2.474324503,
    3.3083693089999997,
    3.7756676330000003,
...
robustness["LF"]["gentle push haptics"] = [
    0.30024437449999997,
    0.39677922369999996,
    0.5125797627,
    0.5798155335,
...
robustness["LF"]["gentle push controls"] = [
    0.30024437449999997,
    1.127455943,
    1.183305545,
    1.2249671009999998,
...
robustness["LF"]["gentle push multimodal"] = [
    0.30024437449999997,
    3.391955101,
    4.6935460419999995,
    5.556768718,
...
robustness["LF-Transformer"]["finance F&B timeseries"] = [
    2.147226333618164,
    2.1456197261810304,
    2.1531070709228515,
    2.1734951019287108,
...
robustness["LF-Transformer"]["finance tech timeseries"] = [
    0.5809576392173768,
    0.5809600591659546,
    0.5805474042892456,
    0.5812169909477234,
...
robustness["LF-Transformer"]["finance health timeseries"] = [
    0.14129721224308014,
    0.14125592708587648,
    0.14108223021030425,
    0.1410686790943146,
...
robustness["LF-Transformer"]["mosi multimodal"] = [
    0.7982,
    0.7287,
    0.6902,
    0.6407,
...
robustness["LF-Transformer"]["mosi text"] = [
    0.7982,
    0.7167,
    0.6902,
    0.6401,
...
robustness["LF-Transformer"]["mosi audio"] = [
    0.7982,
    0.7167,
    0.69,
    0.663,
...
robustness["LF-Transformer"]["mosi image"] = [
    0.7982,
    0.7032,
    0.6531,
    0.6348,
...
robustness["LF-Transformer"]["mosei multimodal"] = [
    0.7998,
    0.732,
    0.689,
    0.6411,
...
robustness["LF-Transformer"]["mosei text"] = [
    0.7902,
    0.7042,
    0.6387,
    0.5615,
...
robustness["LF-Transformer"]["mosei audio"] = [
    0.7902,
    0.6939,
    0.663,
    0.6857,
...
robustness["LF-Transformer"]["mosei image"] = [
    0.7902,
    0.6948,
    0.6643,
    0.6337,
...
robustness["LF-Transformer"]["sarcasm multimodal"] = [
    0.6623,
    0.6131,
    0.5991,
    0.558,
...
robustness["LF-Transformer"]["sarcasm text"] = [
    0.6623,
    0.6012,
    0.6057,
    0.5571,
...
robustness["LF-Transformer"]["sarcasm audio"] = [
    0.6623,
    0.5851,
    0.5733,
    0.5696,
...
robustness["LF-Transformer"]["sarcasm image"] = [
    0.6623,
    0.6183,
    0.6088,
    0.5599,
...
robustness["LF-Transformer"]["humor multimodal"] = [
    0.6323,
    0.5075,
    0.6082,
    0.5481,
...
robustness["LF-Transformer"]["humor text"] = [
    0.6323,
    0.5109,
    0.606,
    0.5472,
...
robustness["LF-Transformer"]["humor audio"] = [
    0.6323,
    0.5851,
    0.5733,
    0.5696,
...
robustness["LF-Transformer"]["humor image"] = [
    0.6323,
    0.5099,
    0.6062,
    0.5448,
...
robustness["LRTF"]["mimic mortality timeseries"] = [
    0.7817290006131208,
    0.773758430410791,
    0.7639484978540773,
    0.7627222562844881,
...
robustness["LRTF"]["mimic 7 timeseries"] = [
    0.687614960147149,
    0.6646229307173513,
    0.6376456161863887,
    0.605456774984672,
...
robustness["LRTF"]["mimic 1 timeseries"] = [
    0.9141630901287554,
    0.8963825873697119,
    0.8761496014714899,
    0.8479460453709381,
...
robustness["LRTF"]["enrico wireframe image"] = [
    0.4863013698630137,
    0.4383561643835616,
    0.4075342465753425,
    0.3698630136986301,
...
robustness["LRTF"]["robotics image"] = [
    2.1845e-05,
    0.005,
    0.009,
    0.0015,
...
robustness["LRTF"]["robotics force"] = [
    2.1447e-05,
    2.1792e-05,
    2.1781e-05,
    2.2270e-05,
...
robustness["LRTF"]["robotics proprio"] = [
    2.2028e-05,
    0.0735,
    0.1396,
    0.1979,
...
robustness["LRTF"]["imdb image micro"] = [
    0.5913649259810668,
    0.5745157767687799,
    0.551883616778386,
    0.5381301803273819,
...
robustness["LRTF"]["imdb image macro"] = [
    0.5021858121516295,
    0.4740446812854553,
    0.4518231380876541,
    0.4319055295920208,
...
robustness["LRTF"]["imdb text micro"] = [
    0.5919325368938863,
    0.5873802816901408,
    0.5816164817749603,
    0.5777803047532409,
...
robustness["LRTF"]["imdb text macro"] = [
    0.5019679402309065,
    0.49360173691357145,
    0.4844043193606097,
    0.47541387082118197,
...
robustness["MI"] = dict()
robustness["MI"]["mimic mortality timeseries"] = [
    0.7765174739423667,
    0.7734518700183937,
    0.7709993868792152,
    0.769773145309626,
...
robustness["MI"]["mimic 7 timeseries"] = [
    0.6799509503372164,
    0.6548129981606376,
    0.6146535867565911,
    0.5781729000613121,
...
robustness["MI"]["mimic 1 timeseries"] = [
    0.9132434089515634,
    0.8963825873697119,
    0.8874923359901901,
    0.8669527896995708,
...
robustness["MI"]["enrico wireframe image"] = [
    0.4417808219178082,
    0.4452054794520548,
    0.4452054794520548,
    0.4383561643835616,
...
robustness["MI"]["imdb image micro"] = [
    0.5777196044211751,
    0.5597235643796304,
    0.5456367924528303,
    0.5246357929645861,
...
robustness["MI"]["imdb image macro"] = [
    0.47106023328788327,
    0.4443405925674904,
    0.4289366994431545,
    0.3960658264667671,
...
robustness["MVAE"]["mimic mortality timeseries"] = [
    0.7823421213979154,
    0.7792765174739423,
    0.775904353157572,
    0.7673206621704476,
...
robustness["MVAE"]["mimic 7 timeseries"] = [
    0.6842427958307786,
    0.6646229307173513,
    0.628755364806867,
    0.5800122624156959,
...
robustness["MVAE"]["mimic 1 timeseries"] = [
    0.9153893316983446,
    0.8988350705088902,
    0.882280809319436,
    0.8746167995095033,
...
robustness["MFM"] = dict()
robustness["MFM"]["mimic mortality timeseries"] = [
    0.7786633966891477,
    0.776824034334764,
    0.7691600245248313,
    0.7660944206008584,
...
robustness["MFM"]["mimic 7 timeseries"] = [
    0.6882280809319435,
    0.6532801961986512,
    0.5901287553648069,
    0.545677498467198,
...
robustness["MFM"]["mimic 1 timeseries"] = [
    0.9153893316983446,
    0.8936235438381361,
    0.8779889638258737,
    0.8556100551808706,
...
robustness["MFM"]["imdb image micro"] = [
    0.38080951341915775,
    0.3777138945927447,
    0.36800526662277816,
    0.36441191039682974,
...
robustness["MFM"]["imdb image macro"] = [
    0.23147720015398293,
    0.22821069574434785,
    0.21837752245395167,
    0.21319344751087604,
...
robustness["MFM"]["imdb text micro"] = [
    0.38452718934265123,
    0.3802497472470421,
    0.3797620020150859,
    0.3744429559559286,
...
robustness["MFM"]["imdb text macro"] = [
    0.23474928943826315,
    0.2302628290785667,
    0.2304606193666061,
    0.22282105747491562,
...
robustness["EF"] = dict()
robustness["EF"]["finance F&B timeseries"] = [
    1.66147058,
    1.71470122,
    1.7545939,
    1.83128624,
...
robustness["EF"]["finance tech timeseries"] = [
    0.5731123566627503,
    0.5743420124053955,
    0.5756734490394593,
    0.5752590298652649,
...
robustness["EF"]["finance health timeseries"] = [
    0.13770209550857543,
    0.13934325873851777,
    0.1396014302968979,
    0.1413800001144409,
...
robustness["EF"]["imdb image micro"] = [
    0.5960651364419497,
    0.578808170615047,
    0.5637010676156583,
    0.5386240629793639,
...
robustness["EF"]["imdb image macro"] = [
    0.5066658310319822,
    0.4837641916821099,
    0.4680108460488566,
    0.4370470195309652,
...
robustness["EF"]["mosei multimodal"] = [
    0.7866,
    0.6941,
    0.6007,
    0.5231,
...
robustness["EF"]["sarcasm multimodal"] = [
    0.6654,
    0.6013,
    0.554,
    0.5275,
...
robustness["EF"]["humor multimodal"] = [
    0.6055,
    0.5691,
    0.5263,
    0.4962,
...
robustness["EF"]["gentle push image"] = [
    0.33170643980000003,
    9.053995443,
    9.537654717999999,
    9.772067782,
...
robustness["EF"]["gentle push proprio"] = [
    0.33170643980000003,
    5.838992061,
    6.571795754,
    6.791380137000001,
...
robustness["EF"]["gentle push haptics"] = [
    0.33170643980000003,
    0.3502492059,
    0.4118775333,
    0.476365505,
...
robustness["EF"]["gentle push controls"] = [
    0.33170643980000003,
    0.3502492059,
    0.4118775333,
    0.476365505,
...
robustness["EF"]["gentle push multimodal"] = [
    0.33170643980000003,
    5.951489512,
    6.887291512000001,
    7.255283361,
...
robustness["EF-Transformer"]["finance F&B timeseries"] = [
    2.157018041610718,
    2.145638656616211,
    2.2730966091156004,
    2.339062786102295,
...
robustness["EF-Transformer"]["finance health timeseries"] = [
    0.1417102575302124,
    0.14171962440013885,
    0.1417176216840744,
    0.14173041582107543,
...
robustness["EF-Transformer"]["finance tech timeseries"] = [
    0.5761273384094239,
    0.5761261582374573,
    0.5761314392089844,
    0.5761253833770752,
...
robustness["EF-Transformer"]["mosi multimodal"] = [
    0.7902,
    0.7089,
    0.6502,
    0.5857,
...
robustness["EF-Transformer"]["mosi text"] = [
    0.7902,
    0.7282,
    0.6612,
    0.6039,
...
robustness["EF-Transformer"]["mosi audio"] = [
    0.7902,
    0.7182,
    0.6933,
    0.6537,
...
robustness["EF-Transformer"]["mosi image"] = [
    0.7902,
    0.7161,
    0.6821,
    0.6456,
...
robustness["EF-Transformer"]["mosei multimodal"] = [
    0.7915,
    0.7155,
    0.6493,
    0.585,
...
robustness["EF-Transformer"]["mosei text"] = [
    0.7915,
    0.7071,
    0.6503,
    0.5842,
...
robustness["EF-Transformer"]["mosei audio"] = [
    0.7915,
    0.7183,
    0.6946,
    0.6548,
...
robustness["EF-Transformer"]["mosei image"] = [
    0.7915,
    0.725,
    0.7036,
    0.6717,
...
robustness["EF-Transformer"]["sarcasm multimodal"] = [
    0.6548,
    0.6192,
    0.6032,
    0.5643,
...
robustness["EF-Transformer"]["sarcasm text"] = [
    0.6548,
    0.6305,
    0.5853,
    0.575,
...
robustness["EF-Transformer"]["sarcasm audio"] = [
    0.6548,
    0.632,
    0.6181,
    0.55,
...
robustness["EF-Transformer"]["sarcasm image"] = [
    0.6548,
    0.5974,
    0.6185,
    0.5621,
...
robustness["EF-Transformer"]["humor multimodal"] = [
    0.6288,
    0.5049,
    0.5327,
    0.5141,
...
robustness["EF-Transformer"]["humor text"] = [
    0.6288,
    0.5149,
    0.5304,
    0.5089,
...
robustness["EF-Transformer"]["humor audio"] = [
    0.6288,
    0.632,
    0.6181,
    0.55,
...
robustness["EF-Transformer"]["humor image"] = [
    0.6288,
    0.5032,
    0.5426,
    0.5195,
...
robustness["GradBlend"]["finance F&B timeseries"] = [
    1.5008137702941895,
    1.5597750902175904,
    1.4509791374206542,
    1.7539066553115845,
...
robustness["GradBlend"]["finance tech timeseries"] = [
    0.5373285174369812,
    0.5378936171531677,
    0.5392054557800293,
    0.5571645736694336,
...
robustness["GradBlend"]["finance health timeseries"] = [
    0.13074953705072404,
    0.13255454301834108,
    0.13356374502182006,
    0.1311644658446312,
...
robustness["GradBlend"]["enrico image"] = [
    0.4897260273972603,
    0.4486301369863014,
    0.410958904109589,
    0.386986301369863,
...
robustness["GradBlend"]["enrico wireframe image"] = [
    0.4965753424657534,
    0.4657534246575342,
    0.4383561643835616,
    0.4417808219178082,
...
robustness["GradBlend"]["mosi multimodal"] = [
    0.7543,
    0.7122,
    0.6568,
    0.6443,
...
robustness["GradBlend"]["mosi text"] = [
    0.7543,
    0.7233,
    0.7003,
    0.6487,
...
robustness["GradBlend"]["mosi audio"] = [
    0.7543,
    0.7235,
    0.7045,
    0.6804,
...
robustness["GradBlend"]["mosi image"] = [
    0.7543,
    0.7244,
    0.6989,
    0.6641,
...
robustness["GradBlend"]["mosei multimodal"] = [
    0.7732,
    0.7115,
    0.6312,
    0.6447,
...
robustness["GradBlend"]["mosei text"] = [
    0.7732,
    0.7111,
    0.6559,
    0.6415,
...
robustness["GradBlend"]["mosei audio"] = [
    0.7732,
    0.722,
    0.7041,
    0.6824,
...
robustness["GradBlend"]["mosei image"] = [
    0.7732,
    0.7203,
    0.7043,
    0.6821,
...
robustness["GradBlend"]["sarcasm multimodal"] = [
    0.6578,
    0.6234,
    0.6415,
    0.4569,
...
robustness["GradBlend"]["sarcasm text"] = [
    0.6578,
    0.6393,
    0.6503,
    0.4866,
...
robustness["GradBlend"]["sarcasm audio"] = [
    0.6578,
    0.6358,
    0.6285,
    0.4557,
...
robustness["GradBlend"]["sarcasm image"] = [
    0.6578,
    0.5982,
    0.6297,
    0.4398,
...
robustness["GradBlend"]["humor multimodal"] = [
    0.6251,
    0.5859,
    0.6021,
    0.6046,
...
robustness["GradBlend"]["humor text"] = [
    0.6251,
    0.5864,
    0.6033,
    0.6045,
...
robustness["GradBlend"]["humor audio"] = [
    0.6251,
    0.6358,
    0.6285,
    0.4557,
...
robustness["GradBlend"]["humor image"] = [
    0.6251,
    0.5972,
    0.603,
    0.6216,
...
robustness["MulT"]["finance F&B timeseries"] = [
    2.0660665035247803,
    2.091330051422119,
    2.1647129535675047,
    2.153086709976196,
...
robustness["MulT"]["finance tech timeseries"] = [
    0.5653551816940308,
    0.5692847371101379,
    0.5836835503578186,
    0.5806204080581665,
...
robustness["MulT"]["finance health timeseries"] = [
    0.13463806509971618,
    0.13365633189678192,
    0.1398583859205246,
    0.14236030280590056,
...
robustness["MulT"]["mosi multimodal"] = [
    0.8337,
    0.7488,
    0.6693,
    0.6526,
...
robustness["MulT"]["mosei multimodal"] = [
    0.8152,
    0.7505,
    0.6632,
    0.6454,
...
robustness["MulT"]["sarcasm multimodal"] = [
    0.7023,
    0.6421,
    0.6184,
    0.5729,
...
robustness["MulT"]["humor multimodal"] = [
    0.6667,
    0.5071,
    0.5201,
    0.5019,
...
robustness["CCA"]["enrico wireframe image"] = [
    0.5205479452054794,
    0.4417808219178082,
    0.4212328767123288,
    0.386986301369863,
...
robustness["CCA"]["imdb image micro"] = [
    0.5979549412888365,
    0.579187598679489,
    0.5572366877785597,
    0.5324244545205563,
...
robustness["CCA"]["imdb image macro"] = [
    0.5052922945325112,
    0.4774283379013967,
    0.4532107402427913,
    0.418973491941983,
...
robustness["CCA"]["imdb text micro"] = [
    0.598883371208933,
    0.5941217831528618,
    0.5879466426013142,
    0.582861350249207,
...
robustness["CCA"]["imdb text macro"] = [
    0.5058683324335825,
    0.49697946097057644,
    0.4878780921741972,
    0.4788777504454515,
...
robustness["TF"]["enrico wireframe image"] = [
    0.5,
    0.4417808219178082,
    0.386986301369863,
    0.3219178082191781,
...
robustness["TF"]["gentle push image"] = [
    0.5139880641,
    283.0832693,
    385.2962356,
    456.36261060000004,
...
robustness["TF"]["gentle push proprio"] = [
    0.5139880641,
    2907.2389239999998,
    4791.740975,
    6813.597632999999,
...
robustness["TF"]["gentle push haptics"] = [
    0.5139880641,
    2.7141630589999997,
    5.188060706,
    7.317023043,
...
robustness["TF"]["gentle push controls"] = [
    0.5139880641,
    150.6061621,
    290.7440733,
    413.71387769999995,
...
robustness["TF"]["gentle push multimodal"] = [
    0.5139880641,
    728.0306158,
    3483.39041,
    8962.23025,
...
robustness["ReFNet"]["imdb image micro"] = [
    0.5976573446169366,
    0.5835463029432879,
    0.5616664699634132,
    0.5364713027634377,
...
robustness["ReFNet"]["imdb image macro"] = [
    0.4999160237577528,
    0.47935456745475646,
    0.45167922260039106,
    0.4226309022780442,
...
robustness["ReFNet"]["imdb text micro"] = [
    0.599182805328557,
    0.5955059331781076,
    0.5918183861541919,
    0.5834299120897758,
...
robustness["ReFNet"]["imdb text macro"] = [
    0.5008901973258216,
    0.49699338944114185,
    0.49214286719209255,
    0.4778059110798838,
...
robustness["ReFNet"]["robotics image"] = [
    2.4650e-05,
    0.0003,
    0.0005,
    0.0006,
...
robustness["ReFNet"]["robotics proprio"] = [
    2.4424e-05,
    0.0603,
    0.1169,
    0.1681,
...
robustness["ReFNet"]["robotics force"] = [
    2.4938e-05,
    2.4861e-05,
    2.4803e-05,
    2.4877e-05,
...
robustness["RMFE"]["imdb image micro"] = [
    0.6024415524588276,
    0.5827195551217204,
    0.5569574184156254,
    0.5370364604415107,
...
robustness["RMFE"]["imdb image macro"] = [
    0.47716090909756703,
    0.45046200743638426,
    0.4243874262395849,
    0.3935334619561985,
...
robustness["RMFE"]["imdb text micro"] = [
    0.6027342179332529,
    0.5976063446286951,
    0.5948144089060652,
    0.5873894767357588,
...
robustness["RMFE"]["imdb text macro"] = [
    0.4772888994608969,
    0.4727183926954104,
    0.4656519534553542,
    0.45563175396079997,
...
robustness["MCTN"]["mosi multimodal"] = [
    0.779,
    0.724,
    0.6832,
    0.6593,
...
robustness["MCTN"]["mosei multimodal"] = [
    0.761,
    0.7251,
    0.6847,
    0.6574,
...
robustness["MCTN"]["sarcasm multimodal"] = [
    0.6342,
    0.6022,
    0.5703,
    0.5665,
...
robustness["MCTN"]["humor multimodal"] = [
    0.6312,
    0.5378,
    0.5044,
    0.4946,
...
robustness["MFAS"]["mimic mortality timeseries"] = [
    0.7614960147148988,
    0.7614960147148988,
    0.7608828939301042,
    0.7611894543225015,
...
robustness["MFAS"]["mimic 7 timeseries"] = [
    0.6879215205395462,
    0.6397915389331699,
    0.5996321275291232,
    0.5748007357449417,
...
robustness["MFAS"]["mimic 1 timeseries"] = [
    0.9141630901287554,
    0.8969957081545065,
    0.8776824034334764,
    0.8611281422440221,
...
robustness["SF"] = dict()
robustness["SF"]["robotics image"] = [
    2.5372693926328793e-05,
    0.00013537800987251103,
    0.0002216917637269944,
    0.0002810211735777557,
    0.00031372791272588074,
    0.000328845955664292,
    0.0003345597942825407,
    0.0003262482350692153,
    0.00031598060741089284,
    0.0003046182682737708,
]
robustness["SF"]["robotics proprio"] = [
    2.5808196369325742e-05,
    0.07510929554700851,
    0.14351879060268402,
    0.20326630771160126,
    0.2524733245372772,
...
robustness["SF"]["robotics force"] = [
    2.5194265617756173e-05,
    2.5528639525873587e-05,
    2.640512684592977e-05,
    2.6921765311271884e-05,
    2.6588038963382132e-05,
    2.632199539220892e-05,
    2.5984008971136063e-05,
    2.670147478056606e-05,
    2.5790803192649037e-05,
    2.5958863261621445e-05,
]
...
mse_tasks = [
    "finance health timeseries",
    "finance F&B timeseries",
    "finance tech timeseries",
    "gentle push image",
    "gentle push proprio",
    "gentle push haptics",
    "gentle push controls",
    "gentle push multimodal",
    "robotics image",
    "robotics force",
    "robotics proprio",
]
