...
class PushTask:
    ...
    def get_test_trajectories(
        ...
        prop_noise=False,
        haptics_noise=False,
        controls_noise=False,
        multimodal_noise=False,
        **dataset_args,
        ...
        if kloss_dataset:
            ...
            if visual_noise:
                for i in range(10):
                    trajectories.append(_load_trajectories("gentle_push_300.hdf5", visual_noise=i / 10, **dataset_args))
            elif prop_noise:
                for i in range(10):
                    trajectories.append(_load_trajectories("gentle_push_300.hdf5", prop_noise=i / 10, **dataset_args))
            elif haptics_noise:
                for i in range(10):
                    trajectories.append(_load_trajectories("gentle_push_300.hdf5", haptics_noise=i / 10, **dataset_args))
            elif controls_noise:
                for i in range(10):
                    trajectories.append(
                        _load_trajectories(
