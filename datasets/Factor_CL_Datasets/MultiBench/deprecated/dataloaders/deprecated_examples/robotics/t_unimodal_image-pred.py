...
import yaml
from fusions.robotics.sensor_fusion import roboticsConcat
from private_test_scripts.all_in_one import all_in_one_train
from robotics_utils import set_seeds
from training_structures.Simple_Late_Fusion import train
from unimodals.common_models import MLP
from unimodals.robotics.encoders import ActionEncoder, DepthEncoder, ImageEncoder
...
class selfsupervised:
    def __init__(self, configs):
        ...
        self.train_loader, self.val_loader = get_data(
            self.device,
            self.configs,
            "/home/pliang/multibench/MultiBench-robotics/",
            unimodal="image",
            output="ee_yaw_next",
        )
    ...
    def train(self):
        ...
        all_in_one_train(trainprocess, self.encoders + [self.fusion, self.head])
