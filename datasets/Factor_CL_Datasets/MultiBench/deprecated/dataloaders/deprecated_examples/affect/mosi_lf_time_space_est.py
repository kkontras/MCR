...
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))  # __file__ father path
print(BASE_DIR)
...
traindata, validdata, testdata = get_dataloader("/home/pliang/multibench/affect/processed/mosei_senti_data.pkl")
...
encoders = [
    GRU(35, 70, dropout=True, has_padding=True).cuda(),
