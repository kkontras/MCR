...
def baselines(robust_test_loader):
    ...
    best_constant_test = best_constant(val_loader.dataset.Y, robust_test_loader.dataset.Y)
    ...
    copy_last_test = copy_last(val_loader.dataset.Y, robust_test_loader.dataset.Y)
    ...
    arima_test = arima(
        torch.cat([train_loader.dataset.Y, val_loader.dataset.Y]),
        robust_test_loader.dataset.Y,
    )
