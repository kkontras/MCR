...
class MFM(nn.Module):
    ...
    def forward(self, inputs):
        ...
        for i in range(len(inputs)):
            recons.append(self.decoders[i](torch.cat([outs[i], combined], dim=1)))
        ...
        if True:
            with torch.no_grad():
                ...
                if task == "classification":
                    ...
                    print("Epoch " + str(ep) + " valid loss: " + str(valoss) + " acc: " + str(acc))
                    ...
                    print("Epoch " + str(ep) + " valid loss: " + str(valoss) + " f1_micro: " + str(f1_micro) + " f1_macro: " + str(f1_macro))
                    if f1_macro > bestf1:
                        patience = 0
                        bestf1 = f1_macro
                        print("Saving Best")
