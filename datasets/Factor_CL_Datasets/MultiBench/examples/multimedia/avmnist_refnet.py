...
channels = 6
encoders = [
    Sequential2(LeNet(1, channels, 3), nn.Linear(channels * 8, channels * 32)).cuda(),
    LeNet(1, channels, 5).cuda(),
]
...
train(
    ...
    lr=0.005,
    objective=RefNet_objective(0.1),
    objective_args_dict={"refiner": refiner},
)
