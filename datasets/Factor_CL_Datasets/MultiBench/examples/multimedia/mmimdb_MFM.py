...
encoders = [
    MaxOut_MLP(512, 512, 300, n_latent, False).cuda(),
...
recon_loss = MFM_objective(2.0, [sigmloss1d, sigmloss1d], [1.0, 1.0], criterion=torch.nn.BCEWithLogitsLoss())
...
train(
    ...
    validdata,
    1000,
    decoders + intermediates,
    early_stop=True,
    task="multilabel",
    objective_args_dict={"decoders": decoders, "intermediates": intermediates},
    save=filename,
