...
traindata, validdata, testdata = get_dataloader("../video/multimodal_imdb.hdf5", "../video/mmimdb", vgg=True, batch_size=800)

outdim = 256
encoders = [
    MaxOut_MLP(512, 512, 300, outdim, False),
...
train(
    ...
    lr=1e-2,
    weight_decay=0.01,
    objective=CCA_objective(outdim, criterion=torch.nn.BCEWithLogitsLoss()),
)
