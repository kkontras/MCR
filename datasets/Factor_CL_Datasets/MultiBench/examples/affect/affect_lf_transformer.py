...
from unimodals.common_models import MLP, Transformer  # noqa
...
traindata, validdata, test_robust = get_dataloader("/home/paul/MultiBench/mosi_data.pkl", robust_test=False)

# mosi/mosei
encoders = [
    Transformer(20, 40).cuda(),
