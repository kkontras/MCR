...
import numpy
import theano
from blocks.bricks import MLP, FeedforwardSequence, Rectifier, Softmax
...
class VGGNet(FeedforwardSequence):
    ...
    def __init__(self, **kwargs):
        ...
        conv_layers = [
            Convolutional(filter_size=(3, 3), num_filters=64, border_mode=(1, 1), name="conv_1"),
            Rectifier(),
            Convolutional(filter_size=(3, 3), num_filters=64, border_mode=(1, 1), name="conv_2"),
            Rectifier(),
            MaxPooling((2, 2), step=(2, 2), name="pool_2"),
            Convolutional(filter_size=(3, 3), num_filters=128, border_mode=(1, 1), name="conv_3"),
            Rectifier(),
            Convolutional(filter_size=(3, 3), num_filters=128, border_mode=(1, 1), name="conv_4"),
            Rectifier(),
            MaxPooling((2, 2), step=(2, 2), name="pool_4"),
            Convolutional(filter_size=(3, 3), num_filters=256, border_mode=(1, 1), name="conv_5"),
            Rectifier(),
            Convolutional(filter_size=(3, 3), num_filters=256, border_mode=(1, 1), name="conv_6"),
            Rectifier(),
            Convolutional(filter_size=(3, 3), num_filters=256, border_mode=(1, 1), name="conv_7"),
            Rectifier(),
            MaxPooling((2, 2), step=(2, 2), name="pool_7"),
            Convolutional(filter_size=(3, 3), num_filters=512, border_mode=(1, 1), name="conv_8"),
            Rectifier(),
            Convolutional(filter_size=(3, 3), num_filters=512, border_mode=(1, 1), name="conv_9"),
            Rectifier(),
            Convolutional(filter_size=(3, 3), num_filters=512, border_mode=(1, 1), name="conv_10"),
            Rectifier(),
            MaxPooling((2, 2), step=(2, 2), name="pool_10"),
            Convolutional(filter_size=(3, 3), num_filters=512, border_mode=(1, 1), name="conv_11"),
            Rectifier(),
            Convolutional(filter_size=(3, 3), num_filters=512, border_mode=(1, 1), name="conv_12"),
            Rectifier(),
            Convolutional(filter_size=(3, 3), num_filters=512, border_mode=(1, 1), name="conv_13"),
            Rectifier(),
        ...
        super(VGGNet, self).__init__([conv_sequence.apply, Flattener().apply, mlp.apply], **kwargs)
